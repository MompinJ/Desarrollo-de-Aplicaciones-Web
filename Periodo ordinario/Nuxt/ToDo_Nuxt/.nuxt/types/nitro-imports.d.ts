declare global {
  ...
  const createTask: typeof import('../../server/utils/store').createTask
  ...
  const deleteTask: typeof import('../../server/utils/store').deleteTask
  ...
  const getTasks: typeof import('../../server/utils/store').getTasks
  ...
  const updateTask: typeof import('../../server/utils/store').updateTask
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/home/mompin/ProgrammingProjects/Temporal/NUXT/proyecto2-todo/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/home/mompin/ProgrammingProjects/Temporal/NUXT/proyecto2-todo/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { getTasks, createTask, updateTask, deleteTask } from '/home/mompin/ProgrammingProjects/Temporal/NUXT/proyecto2-todo/server/utils/store';