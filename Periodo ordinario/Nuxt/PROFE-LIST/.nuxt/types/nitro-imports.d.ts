declare global {
  ...
  const createAlumno: typeof import('../../server/utils/store').createAlumno
  const createApp: typeof import('../../node_modules/h3').createApp
  const createAppEventHandler: typeof import('../../node_modules/h3').createAppEventHandler
  const createError: typeof import('../../node_modules/h3').createError
  const createEvent: typeof import('../../node_modules/h3').createEvent
  const createEventStream: typeof import('../../node_modules/h3').createEventStream
  const createGrupo: typeof import('../../server/utils/store').createGrupo
  ...
  const deleteAlumno: typeof import('../../server/utils/store').deleteAlumno
  const deleteCookie: typeof import('../../node_modules/h3').deleteCookie
  const deleteGrupo: typeof import('../../server/utils/store').deleteGrupo
  ...
  const getAlumnoById: typeof import('../../server/utils/store').getAlumnoById
  const getAlumnos: typeof import('../../server/utils/store').getAlumnos
  const getAsistencias: typeof import('../../server/utils/store').getAsistencias
  const getCookie: typeof import('../../node_modules/h3').getCookie
  const getEstadisticasPorGrupo: typeof import('../../server/utils/store').getEstadisticasPorGrupo
  const getGrupoById: typeof import('../../server/utils/store').getGrupoById
  const getGrupos: typeof import('../../server/utils/store').getGrupos
  ...
  const registrarAsistencia: typeof import('../../server/utils/store').registrarAsistencia
  ...
  const updateAlumno: typeof import('../../server/utils/store').updateAlumno
  const updateGrupo: typeof import('../../server/utils/store').updateGrupo
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/home/mompin/ProgrammingProjects/Temporal/NUXT/proyecto3-asistencias/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/home/mompin/ProgrammingProjects/Temporal/NUXT/proyecto3-asistencias/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { getGrupos, getGrupoById, createGrupo, updateGrupo, deleteGrupo, getAlumnos, getAlumnoById, createAlumno, updateAlumno, deleteAlumno, getAsistencias, registrarAsistencia, getEstadisticasPorGrupo } from '/home/mompin/ProgrammingProjects/Temporal/NUXT/proyecto3-asistencias/server/utils/store';